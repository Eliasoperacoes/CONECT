...
test('os arquivos .sql não têm delimitador de corpo quebrado', async () => {
   ...
   */
  for (const arquivo of ['esquema.sql', 'acessos.sql', 'organograma.sql', 'conserto-login.sql', 'resetar-acesso.sql', 'liberar-acesso.sql', 'permissoes.sql', 'qr-por-loja.sql', 'mensagem-fixada.sql']) {
