...
test('o saldo acumulado segue a pessoa, não o aparelho', async () => {
  ...
  // Depois de sincronizar o saldo aparece: das 8h às 18h com 1h de almoço = 9h,
  // uma hora acima da jornada de 8h
  ...
  expect(servicoPonto.obterSaldoAcumulado('colab-elias')).toBe(60);
});
