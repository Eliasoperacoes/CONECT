...
| 24 | `atestado-e-do-rh.sql` | **Atestado é do RH; folga é da cadeia.** Uma líder recusou o atestado de outra pessoa porque a regra de decisão era a mesma da hora extra. Atestado é documento — o líder não tem como julgá-lo, e nem deveria lê-lo (dado de saúde). Muda leitura, decisão e criação por **tipo**. Depende do 20 |
